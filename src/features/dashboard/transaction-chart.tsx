...
const formatHourlyData = (timeScaleData: any[]) => {
...
const formatWeeklyData = (timeScaleData: any[]) => {
...
const formatMonthlyData = (timeScaleData: any[]) => {
